...
$query = "SELECT id_departamento, nombre_departamento FROM  departamentos ORDER BY nombre_departamento ASC";
    ...
    <header>
        ...
        <nav class="menu">
            ...
            <li><a href="InicioAdmin.php"><i class="fas fa-home"></i> Inicio</a></li>
                ...
                <li><a href="Usarios.php"><i class="fas fa-users"></i> Control de usuarios</a></li>
...
<!--------------------------------------------------Estructura formulario-------------------------------------------------------------------------->
        ...
        <div class="Contenedor2">
            <a href="" class="btn_Modi">Modificar</a>
        </div>
    </body>
</html>